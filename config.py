...
PICS = (environ.get('PICS', 'https://envs.sh/jTI.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "Pirates_File_Store_Bot") # without @
...
CLONE_DB_URI = environ.get("CLONE_DB_URI", "mongodb+srv://rockybhai2109rs:phaCSLU6FEuADH8i@cluster0.lvv2o.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
